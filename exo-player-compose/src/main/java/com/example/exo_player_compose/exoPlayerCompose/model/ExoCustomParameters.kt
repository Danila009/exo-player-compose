...
data class ExoCustomParameters(
    ...
    var previewSeekBarParameters:PreviewSeekBarParameters = PreviewSeekBarParameters(),
    var doubleTapParameters:DoubleTapParameters = DoubleTapParameters(),
    var exoFilterParameters:ExoFilterParameters = ExoFilterParameters(),
