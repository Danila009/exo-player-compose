...
package com.example.exo_player_compose.previewSeekBar.exoplayer;
...
import com.example.exo_player_compose.previewSeekBar.PreviewDelegate;
import com.example.exo_player_compose.previewSeekBar.PreviewLoader;
import com.example.exo_player_compose.previewSeekBar.PreviewSeekBar;
import com.example.exo_player_compose.previewSeekBar.animator.PreviewAnimator;
 ...
 */
public class PreviewExoSeekBar extends DefaultTimeBar implements PreviewBar {
    ...
    public PreviewExoSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
